    ...
    <form id="form" action="<?=URL?>/produtos/cadastrar" method="POST">
            ...
            <div id="compartilharObras">
                <div id="img">
                    <div id="controleSvg">
                        ...
                        <div id="file">
                            <input type="file" name="img" placeholder="Escolher arquivo" value="<?=$dados['img']?>" id="<?= $dados['preencha_img'] ? 'invalido' : '' ?>" />
                ...
                <div id="descricao">
                    ...
                    <textarea type="text" name="descricao" placeholder="Descricao" value="<?=$dados['descricao']?>" id="<?= $dados['preencha_descricao'] ? 'invalido' : '' ?>" ></textarea>
                </div>
                <div id="precoEurl">
                    <div id="preco">
                    ...
                    <div id="url">
                        <input type="text" name="urlProduto" placeholder="URL pesonalizada" value="<?=$dados['urlProduto']?>" id="<?= $dados['preencha_urlProduto'] ? 'invalido' : '' ?>" />
                    </div>
                </div>
            </div>
        </div>
        <div id="containerDocs">
            ...
            <div id="blocoConteudoDegrade">
                ...
                <div id="compartilharObras">
                    <div id="anexos">
                        <img src="<?= URL ?>/public/img/img_criar_1.jpeg">
                        <img src="<?= URL ?>/public/img/img_criar_2.jpeg">
                    </div>
                </div>
            </div>
        </div>
